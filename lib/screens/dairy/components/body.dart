...
class Body extends StatelessWidget {
  Body({required this.dairyProduct, Key? key}) : super(key: key);
  ProductModel dairyProduct;
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        dairyProduct.product![i].productName!,
                        style: TextStyle(
                          fontSize: 18,
                          color: Colors.black,
                      ...
                      Row(
                        children: [
                          Text(
                            'Rs.${dairyProduct.product![i].productPrice!}',
                            style: TextStyle(
                              fontWeight: FontWeight.bold,
                              fontSize: 15,
                            ),
